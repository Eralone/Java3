...
public class NetworkClient extends Application {
    ...
    private void openAuthWindow() throws IOException { //Окно авторизации
        ...
        loader.setLocation(NetworkClient.class.getResource("/auth-view.fxml")); //Лоадер должен выглядеть, как созданная вьюха
    ...
    public void createMainChatWindow() throws IOException { //Основное окно (чат)
