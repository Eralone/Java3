...
public class User {
    ...
    private void addUserSQL() { //TODO добавляет в список SQL нового юзера
        try {
            BaseAuthService.getStatement().execute("INSERT OR IGNORE INTO auth VALUES (" +
                    "NULL,\'"+ login +"\', \'" + password +"\', \'" + username + "\');");
        } catch (SQLException throwables) {
            System.out.println("Неправильно добавлен User в SQL");
